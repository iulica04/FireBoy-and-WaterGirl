...
public class Player : MonoBehaviour
{
    ...
    private bool IsGrounded()
    {
        ...
        RaycastHit2D r = Physics2D.Raycast(capsulecollider.bounds.center, Vector2.down, 1.2f, platform);
        Debug.DrawRay(capsulecollider.bounds.center, Vector2.down * 1.2f, Color.red); // Vizualizează raycast-ul
